...
# $remoteScriptUrl = "https://raw.githubusercontent.com/Brachi-Itzkowitz/AutoCustomBackgroundDesktop/main/script1.ps1"
$remoteImageUrl  = "https://raw.githubusercontent.com/Brachi-Itzkowitz/AutoCustomBackgroundDesktop/main/backgrounds/1.jpg"

# --- Target date / countdown ---
$targetDay  = Get-Date "2025-12-07"
$today      = Get-Date
